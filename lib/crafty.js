	...
	_Particles: {
      ...
      offsets: {x: -10, y: -10}
		...
		initParticle: function (particle) {
			particle.position.x = this.position.x + this.positionRandom.x * this.RANDM1TO1() + this.offsets.x;
			particle.position.y = this.position.y + this.positionRandom.y * this.RANDM1TO1() + this.offsets.y;
